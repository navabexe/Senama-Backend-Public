...
def approve_vendor(db: Database, vendor_id: str, admin_id: str, ip_address: str) -> VendorResponse:
    try:
    ...
    if vendor["status"] == "active":
        raise APIException("FORBIDDEN", "Vendor already active")
    ...
    return map_db_to_response(updated_vendor, VendorResponse)  # یا UserResponse بسته به مدل
